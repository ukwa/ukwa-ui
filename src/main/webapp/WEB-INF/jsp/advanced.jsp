      ...
      <form action="" method="get" enctype="multipart/form-data" name="search_form">
        ...
        <div class="row padding-top-20">
          <div class="col-md-4 col-sm-12 padding-vert-10">
            <button title="Select a subject" type="button" class="button button-blue width-100 text-small form-button-down-arrow"> Select a subject</button>
          </div>
          <div class="col-md-4 col-sm-12 padding-vert-10">
            <button title="Select a special collection" type="button" class="button button-blue width-100 text-small form-button-down-arrow"> Select a special collection</button>
          </div>
          <div class="col-md-4 col-sm-12 padding-vert-10">
            <button title="Select an organisation" type="button" class="button button-blue width-100 text-small form-button-down-arrow"> Select an organisation</button>
          </div>
        </div>
        <div class="row padding-top-20">
        ...
        <div class="row padding-top-20">
          <div class="col-sm-12">
            <button type="submit" title="Search" class="button button-white form-button-right-arrow right-arrow float-right"> Search</button>
          </div>
        </div>
      </form>
    </div>
