    ...
    <form action="search" method="get" enctype="multipart/form-data" name="search_form" id="search_form">
        <div class="row">
            <div class="col-12">
                <div class="container-search-field-group">
                    <input type="text" name="text" id="text" title="<spring:message code="search.main.input.title" />" aria-label="<spring:message code="search.main.input.title" />" placeholder="<spring:message code="search.main.input.title" />" class="main-search-field-redesign" value="${originalSearchRequest}" style="color: #0c49b0" required/>
        ...
        <div class="row">
            <div class="col-12 left dialog-link">
                <a href="#" data-toggle="modal" data-target="#searchingUKWAModalCenter" class="no-decoration" title="Get the most from searching the UKWA" style="color: #0c49b0"><spring:message code="search.tips.tipsnotes" /></a>
            </div>
        </div>
