<div class="collection-description"><div class="collection-description-content"></div><div class="collection-readmore-cont"><img src="img/icons/up-arrow-gray.png" class="collection-readmore-arrow collection-readmore-up" tabindex="0" title="Close"/></div></div>
...
<c:if test="${!fn:startsWith(textUri, '/en/') && textUri != '/en'}">
  <div class="header-menu-item"><span lang="en"><a href="/en<c:out value="${textUriWithoutLang}"/>" title="<spring:message code="main.menu.english.title" />"><spring:message code="main.menu.english" /></a></span></div>
</c:if>

<c:if test="${!fn:startsWith(textUri, '/cy/') && textUri != '/cy'}">
<div class="header-menu-item"><span lang="cy"><a href="/cy<c:out value="${textUriWithoutLang}"/>" title="<spring:message code="main.menu.welsh.title" />"><spring:message code="main.menu.welsh" /></a></span></div>
</c:if>

<c:if test="${!fn:startsWith(textUri, '/gd/') && textUri != '/gd'}">
  <div class="header-menu-item"><span lang="gd"><a href="/gd<c:out value="${textUriWithoutLang}"/>" title="<spring:message code="main.menu.scottish.title" />"><spring:message code="main.menu.scottish" /></a></span></div>
</c:if>
