...
<div class="container">
    ...
    <div class="card-deck">
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image9.png" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Arts and Culture</h4>
                <p class="card-text">This is Arts and Culture additional content.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            </div>
        </div>
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image5.png" alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image6.png" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Politics and Government</h4>
                <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image1.png" alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image22.png" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Science Technology and Medicine</h4>
                <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image5.png" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Society and Community</h4>
        ...
        <div class="w-100 d-none d-md-block d-lg-none"><!-- wrap every 3 on md--></div>
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image7.png" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Sport and Recreation</h4>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            </div>
        </div>
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image3.png" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Science Technology and Medicine</h4>
                <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        ...
        <div class="w-100 d-none d-lg-block d-xl-none"><!-- wrap every 4 on lg--></div>
        <div class="card mb-4">
            <img class="card-img-top img-fluid" src="img/categories/image10.png" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Sport and Recreation</h4>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
