...
<head>
    ...
    <title>${currentCollection.name} - UK Web Archive</title>
    <meta charset="utf-8">
    ...
    <div id="global-breadcrumb" class="header-context">
        <nav>
            <ol class="group">
                ...
                <li><a href="collection/${currentCollection.id}">${currentCollection.name}</a></li>
    ...
    <article>
        ...
        <div class="row">
                ...
                <ul id="collection-tree-list" class="list-group">
                    ...
                    <c:forEach items="${subCollections}" var="collection">
                        <li class="list-group-item">&nbsp;
                            <a href="collection/<c:out value="${collection.id}"/>">
            ...
            <div class="col-md-8 col-xs-12">
                ...
                <form action="collection/${currentCollection.id}/search" method="POST" >



                    <input type="hidden" name="collectionId" id="collectionId" value="${currentCollection.id}">
                                ...
                                <div class="thumbnail">
                                    <a href="target/<c:out value="${targetWebsite.id}"/>">
                                        ...
                                        <img class="img-responsive img-rounded"
                                             height="117"
                                             width="117"
                                             src="assets/images/${targetWebsite.screenshot}"
                                             alt="Screenshot"
                                             title="<c:out value="${targetWebsite.name}"/>">
