...
<div class="container-fluid">
    ...
    <section id="content">
        ...
        <div class="default-padding text-content">
            ...
            <p>
                <a href="#crawlersettings" data-toggle="collapse" class="q-grid no-decoration">UK Web Archive Crawler Settings</a>
            <div id="crawlersettings" class="collapse">
                The UK Web Archive endeavours to request permissions from website content owners before crawling a site, usually by email or letter. Our crawler is set to a polite rate to minimise traffic on websites. Its IP address is 194.66.232.85, and it identifies itself as: "Mozilla/5.0 (compatible; heritrix/1.14.1 +http://www.webarchive.org.uk/)".<br>
            ...
            <p>
                <a href="#crawlerfriendly" data-toggle="collapse" class="q-grid no-decoration">Making Your Website Crawler-Friendly</a>
            <div id="crawlerfriendly" class="collapse">
                There are a number of things which you can do to help the UK Web Archive capture as much content as possible from your website:<br>
                Create a Site Map page. An XML site map can also be useful. Creating a sitemap ensures all the website content can be crawled (some pages may not be discoverable by the crawler, for example pages which use Flash or JavaScript navigation).<br>
                Use robots.txt to prevent access to areas of the site which may cause problems if crawled e.g. databases, including online catalogues; "shopping baskets", etc.<br>
            ...
            <div id="cantatchive" class="collapse">
                The current generation of web crawlers cannot capture:<br>
                Dynamically generated content<br>
                Content that is only available via a search engine on the website<br>
                Some types of JavaScript-driven menus<br>
                YouTube videos, Flash movies and similar streaming audio or video (some audio files can, however, be captured)<br>
            ...
            <p>
                <a href="#searchengines" data-toggle="collapse" class="q-grid no-decoration">Search Engines and the UK Web Archive</a>
            <div id="searchengines" class="collapse">
                The UK Web Archive site is indexed by search engines but only to the level of the information pages: search engines are not allowed to index the archived sites.<br>
            ...
            <div id="linking" class="collapse">
                All sites are welcome to link to the UK Web Archive.<br>
            ...
            <div id="techbkg" class="collapse">
                ...
                WCT allows web archivists to manage their workflows for the following core processes:<br>

                Harvest authorisation: getting permission to harvest Web material and make it available<br>
                Selection, scoping and scheduling: what will be harvested, how, when and how often<br>
                Description: adding descriptive metadata<br>
                Harvesting: downloading the material at the appointed time using the Heritrix Web harvester<br>
                Quality Assurance (QA): making sure the harvest worked as expected, and correcting simple harvest errors.<br>
