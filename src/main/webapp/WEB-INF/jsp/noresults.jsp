...
<section id="noresults-header">
  <div class="row header-blue white">
    <div class="col-md-12 col-sm-12 margin-top-minus-20"><a href="javascript:window.history.back();" class="no-decoration"><img class="h3-icon" src="img/icons/left-arrow-white.png"/><span class="text-big bold">Back to the list</span></a>
    </div>
