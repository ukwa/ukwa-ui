...
public class HomeController {
    ...
    @RequestMapping(value = "ukwa/info/{pageName:about|nominate|faq|contact|terms_conditions|privacy|notice_takedown|search_tips|cookies|technical|accessibility_statement|categoriesV2|categoriesV3}", method = GET)
